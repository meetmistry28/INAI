        ...
        <section className="zigzag-section">
          <div className="zigzag-row">
            ...
            <div className="zigzag-content">
              ...
              <a href="/portfoilo/Inai-life" className="read-more-btn">Read More</a>
            </div>
          </div>
          ...
          <div className="zigzag-row reverse">
            ...
            <div className="zigzag-content">
              ...
              <a href="/portfoilo/Influwket" className="read-more-btn">Read More</a>
            </div>
          </div>
          ...
          <div className="zigzag-row ">
            ...
            <div className="zigzag-content">
              ...
              <a href="/portfoilo/Veedket" className="read-more-btn">Read More</a>
            </div>
          </div>
          ...
          <div className="zigzag-row reverse">
            ...
            <div className="zigzag-content">
              ...
              <a href="/portfoilo/Offiket" className="read-more-btn">Read More</a>
            </div>
          </div>
