...
const Blog3 = () => {
  ...
  return (
    <>
      <Helmet>
        <title>What Is Web Scraping? Ultimate Beginner’s Guide | INAI Worlds</title>
        <meta
          name="description"
          content="Discover what web scraping is, how it works, and why it’s essential for data collection. Learn beginner-friendly techniques in this INAI Worlds blog."
        />
      </Helmet>
